...
<section id="salones">
    ...
    <div class="container">
        ...
        <div class="col-md-12 text-center titulo">
            <h1>CONTAMOS CON LOS MEJORES SALONES</h1>
            <h1>PARA EVENTOS EMPRESARIALES Y SOCIALES</h1>
        </div>
